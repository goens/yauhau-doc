...
The above graph depicts the use of the algorithms that fetch blog data from other services in the whole blog program.
Note that 3 requests would be issued to get the ids of the posts because the algorithm is called in 3 different parts (`popular-posts`, `topics`, `main-pane`) of the program.
