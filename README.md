...
rewrites on an intermediate representation of the program that allow
it to batch I/O calls to the same source whenever possible, while
maintaining the functionality of the program.

![img](/figures/rewrite-basic.png) The program transformation to
